...
-- at runtime using the environment variable network_scanner_bindir.
...
-- environment variable network_scanner_libdir.
...
-- using the environment variable network_scanner_dynlibdir.
...
-- runtime using the environment variable network_scanner_datadir.
...
-- variable network_scanner_libexedir.
...
-- using the environment variable network_scanner_sysconfdir.
...
libdir     = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.12.2-9b33/network-scanner-0.1.0.0-inplace-network-scanner-exe"
dynlibdir  = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.12.2-9b33"
datadir    = "/home/runner/.cabal/share/x86_64-linux-ghc-9.12.2-9b33/network-scanner-0.1.0.0"
libexecdir = "/home/runner/.cabal/libexec/x86_64-linux-ghc-9.12.2-9b33/network-scanner-0.1.0.0"
sysconfdir = "/home/runner/.cabal/etc"

getBinDir     = catchIO (getEnv "network_scanner_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "network_scanner_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "network_scanner_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "network_scanner_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "network_scanner_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "network_scanner_sysconfdir") (\_ -> return sysconfdir)
